  ...
  return(
    <div className='min-h-screen w-full flex flex-col gap-24'>
      ...
      <div className='absolute inset-0 flex items-center align-center justify-center mt-45'>
          <button onClick={()=>navigate("/college-dashboard")} className="text-black font-bold px-12 py-4  bg-white border-2 border-black border-dotted z-10">Get Started</button>
       </div> 
